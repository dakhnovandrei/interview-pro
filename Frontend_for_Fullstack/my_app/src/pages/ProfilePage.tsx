...
export const ProfilePage = () => {
  ...
  // ---------- Load interviews with filters and pagination ----------
  ...
  useEffect(() => {
    loadInterviews(1);
  }, [filterPosition, filterCompany, filterType, searchTerm, pageSize, sortBy, sortOrder, loadInterviews]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 md:p-8">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* ---------- Right Column: Interviews with Filters ---------- */}
          <div className="bg-white shadow-lg rounded-2xl p-6">
              ...
              <div className="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200 space-y-3">
                ...
                {hasActiveFilters && (
                  <button
                    ...
                    className="w-full text-sm bg-red-100 hover:bg-red-200 text-red-700 py-2 rounded-lg font-semibold transition"
                  >
                    Clear Filters
                  </button>
                )}
            ...
            {loadingInterviews ? (
              ...
              <div className="text-center py-8">
                <p className="text-gray-400 text-sm mb-4">No interviews found</p>
                {hasActiveFilters && (
                  <button
                    onClick={handleClearFilters}
                    ...
                    >
                      ...
                      {interview.status && (
                        <span className={`text-xs mt-1 block py-1 px-2 rounded font-semibold ${
                          interview.status === 'completed' || interview.status === 'finished'
                ...
                {totalPages > 1 && (
                  <div className="flex items-center justify-between pt-4 border-t">
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={() => loadInterviews(currentPage - 1)}
